...
m12=: 3&*    NB. Triple
m13=: *&3    NB.    "
m14=: 0j1&*  NB. j. (Multiply by _1^1r2)
m15=: ^@j.   NB. r. (Complex # on unit circle at y raadians)
m16=: 1p1&*  NB. pi times
mm16 =: o.   NB.    "
m17=: 0.5&*  NB. Halve -:
m18=: *&0.5  NB.    "
...
m56=: BCT=: !/&i.~      NB. BC table of orders to y-1
...
m66=: 1&,@$ $ ,   NB. Itenize (append leading 1 to shape) ,:
m67=: sin  =:  1&o.  NB. Sin
